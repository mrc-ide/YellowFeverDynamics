...
Population and vaccination data is stored in a list object as described in Guide 2 - Inputs [Link TBA]. Here an example data set for multiple regions is loaded and the vaccination and population data for the first included region is extracted:
