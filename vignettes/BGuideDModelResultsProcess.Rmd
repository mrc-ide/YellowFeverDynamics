---
title: "Guide 4 - Processing Model Results"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Guide 4 - Processing Model Results}
...
This vignette demonstrates how the output of the dynamic yellow fever model functions (see Worked Example 1 [Link TBA] [Link TBA]) can be processed to produce epidemiological data similar to that produced by real-world surveillance. There are three types of data processed by the package:
...
A set of epidemiological data for multiple regions can be constructed using additional functions described in Worked Example 2 [Link TBA]; this combines running the model as described in Worked Example 1 [Link TBA] and calculating epidemiological output data as described in this vignette.

Data is generated as described in Worked Example 1 [Link TBA], in this case using the Full_Model_Run() function in order to be able to calculate all three epidemiological data types.
