...
[[cpp11::register]]
SEXP dust_cpu_FullModelODDelay_alloc(cpp11::list r_pars, bool pars_multi, size_t step,
...
[[cpp11::register]]
SEXP dust_cpu_FullModelODDelay_update_state(SEXP ptr, SEXP r_pars, SEXP r_state,
...
[[cpp11::register]]
SEXP dust_cpu_FullModelODDelay_filter(SEXP ptr, SEXP step_end,
...
public:
  ...
  FullModelODDelay(const dust::pars_type<FullModelODDelay>& pars) :
...
namespace dust {
template<>
dust::pars_type<FullModelODDelay> dust_pars<FullModelODDelay>(cpp11::list user) {
  using real_type = typename FullModelODDelay::real_type;
  auto shared = std::make_shared<FullModelODDelay::shared_type>();
  FullModelODDelay::internal_type internal;
  shared->FOI_max = 1;
  ...
  return dust::pars_type<FullModelODDelay>(shared, internal);
}
template <>
...
cpp11::sexp dust_FullModelODDelay_capabilities() {
  return dust::r::dust_capabilities<FullModelODDelay>();
}

cpp11::sexp dust_FullModelODDelay_gpu_info() {
  return dust::gpu::r::gpu_info();
}
using model_cpu = dust::dust_cpu<FullModelODDelay>;

SEXP dust_cpu_FullModelODDelay_alloc(cpp11::list r_pars, bool pars_multi, size_t step,
                             cpp11::sexp r_n_particles, size_t n_threads,
                             cpp11::sexp r_seed, bool deterministic,
                             cpp11::sexp gpu_config) {
  return dust::r::dust_cpu_alloc<FullModelODDelay>(r_pars, pars_multi, step, r_n_particles,
...
SEXP dust_cpu_FullModelODDelay_set_data(SEXP ptr, cpp11::list data,
                                       bool shared) {
