...
Population and vaccination data is stored in a list object as described in Vignette 2. Here an example data set for multiple regions is loaded from the package and a smaller data set for a single region is constructed:
...
vacc_data=input_data$vacc_data  # Vaccination coverage in each age group by year
pop_data=input_data$pop_data    # Population in each age group by year
