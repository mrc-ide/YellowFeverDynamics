...
vaccine_efficacy <- 1.0             # Proportional vaccine efficacy (from 0 to 1); probability of vaccination successfully
                                    # providing immunity (i.e. moving vaccinated individual to group V)
