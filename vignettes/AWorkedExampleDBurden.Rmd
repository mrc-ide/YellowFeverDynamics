...
input_data_novacc$vacc_data <- input_data_novacc$vacc_data*0 #Amend input data to remove all vaccination
results_novacc<-total_burden_estimate(type,param_dist,input_data_novacc,NULL,years_data,n_reps,mode_start,dt,enviro_data,
                                      R0_fixed_values,vaccine_efficacy0,p_rep_severe0,p_rep_death0,flag_reporting)
