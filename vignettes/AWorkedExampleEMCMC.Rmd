...
We set additional input parameters as follows:
...
```{r,eval=FALSE}
MCMC(pars_ini, input_data, obs_sero_data, obs_case_data, obs_outbreak_data, Niter, type, pars_min, pars_max, n_reps, mode_start, prior_type, dt, enviro_data, R0_fixed_values, vaccine_efficacy, p_rep_severe, p_rep_death, filename_prefix)
```
