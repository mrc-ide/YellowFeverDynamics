...
# efficacy, severe non-fatal case reporting probability, fatal case reporting probability)
...
# If mode_start = 1, shift some non-vaccinated individuals into recovered for herd immunity
mode_start <- 1 
