...
[[cpp11::register]]
SEXP dust_cpu_SEIRVModelReactive_alloc(cpp11::list r_pars, bool pars_multi, cpp11::sexp r_time,
...
[[cpp11::register]]
SEXP dust_cpu_SEIRVModelReactive_update_state(SEXP ptr, SEXP r_pars, SEXP r_state,
...
[[cpp11::register]]
SEXP dust_cpu_SEIRVModelReactive_filter(SEXP ptr, SEXP time_end,
...
public:
  ...
  void update(size_t step, const real_type * state, rng_state_type& rng_state, real_type * state_next) {
    ...
    real_type cluster_flag1 = (flag2a == 1 ? 1 : (F_I_total >= shared->cluster_threshold1 ? 1 : 0));
    for (int i = 1; i <= shared->N_age; ++i) {
...
using model_cpu = dust::dust_cpu<SEIRVModelReactive>;
...
SEXP dust_cpu_SEIRVModelReactive_alloc(cpp11::list r_pars, bool pars_multi, cpp11::sexp r_time,
                             ...
                             cpp11::sexp r_seed, bool deterministic,
                             cpp11::sexp gpu_config, cpp11::sexp ode_control) {
  return dust::r::dust_cpu_alloc<SEIRVModelReactive>(r_pars, pars_multi, r_time, r_n_particles,
...
SEXP dust_cpu_SEIRVModelReactive_simulate(SEXP ptr, cpp11::sexp r_time_end) {
...
SEXP dust_cpu_SEIRVModelReactive_set_data(SEXP ptr, cpp11::list data,
                                       bool shared) {
