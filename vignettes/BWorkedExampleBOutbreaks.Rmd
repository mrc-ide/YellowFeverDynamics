...
model_results <- case_data_generate(FOI_spillover, R0, vacc_data, pop_data, year0 = input_data$years_labels[1],
                                    mode_start = 1, n_reps = 1, year_end = 2001, year_data_begin = 1999,
                                    vaccine_efficacy = 1.0, start_SEIRV = NULL, dt = 1.0)
```
...
year_end = 2010
outbreak_risk <- outbreak_risk_generate(FOI_spillover, R0, vacc_data, pop_data, year0 = input_data$years_labels[1],
                                        mode_start = 1, n_sets=1, n_reps = 1000, year_end, year_data_begin,
                                        vaccine_efficacy = 1.0, start_SEIRV = NULL, dt = 1.0, p_rep_severe, p_rep_death)
