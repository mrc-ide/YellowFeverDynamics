---
title: "Vignette 8 - Parameter Estimation Using Markov Chain Monte Carlo Functions"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Vignette 8 - Parameter Estimation Using Markov Chain Monte Carlo Functions}
...
Input data, environmental data and the observed data to be used for comparison are loaded as described in earlier vignettes:
...
The MCMC() function is then run. Parameter values (proposed and accepted) along with the associated likelihood values are recorded at each iteration and saved to an output file every 10 iterations.
