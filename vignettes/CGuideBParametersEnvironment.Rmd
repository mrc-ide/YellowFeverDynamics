...
shape_data <- map_shapes_load(regions, shapefiles=c(paste(path.package("YellowFeverDynamics"), "/inst/exdata/shapefile_example.shp", sep = "")), region_label_type="GID_1")
colour_scheme=readRDS(file=paste(path.package("YellowFeverDynamics"), "inst/exdata/colour_scheme_example.Rds", sep="/"))
