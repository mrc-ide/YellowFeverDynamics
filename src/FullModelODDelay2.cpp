...
[[cpp11::register]]
SEXP dust_cpu_FullModelODDelay2_alloc(cpp11::list r_pars, bool pars_multi, size_t time,
...
[[cpp11::register]]
SEXP dust_cpu_FullModelODDelay2_update_state(SEXP ptr, SEXP r_pars, SEXP r_state,
...
[[cpp11::register]]
SEXP dust_cpu_FullModelODDelay2_filter(SEXP ptr, SEXP time_end,
...
public:
  ...
  FullModelODDelay2(const dust::pars_type<FullModelODDelay2>& pars) :
...
namespace dust {
template<>
dust::pars_type<FullModelODDelay2> dust_pars<FullModelODDelay2>(cpp11::list user) {
  using real_type = typename FullModelODDelay2::real_type;
  auto shared = std::make_shared<FullModelODDelay2::shared_type>();
  FullModelODDelay2::internal_type internal;
  shared->FOI_max = 1;
  ...
  return dust::pars_type<FullModelODDelay2>(shared, internal);
}
template <>
cpp11::sexp dust_info<FullModelODDelay2>(const dust::pars_type<FullModelODDelay2>& pars) {
  const FullModelODDelay2::internal_type internal = pars.internal;
  const std::shared_ptr<const FullModelODDelay2::shared_type> shared = pars.shared;
...
cpp11::sexp dust_FullModelODDelay2_capabilities() {
  return dust::r::dust_capabilities<FullModelODDelay2>();
}

cpp11::sexp dust_FullModelODDelay2_gpu_info() {
  return dust::gpu::r::gpu_info();
}
using model_cpu = dust::dust_cpu<FullModelODDelay2>;

SEXP dust_cpu_FullModelODDelay2_alloc(cpp11::list r_pars, bool pars_multi, size_t time,
                             cpp11::sexp r_n_particles, size_t n_threads,
                             cpp11::sexp r_seed, bool deterministic,
                             cpp11::sexp gpu_config) {
  return dust::r::dust_cpu_alloc<FullModelODDelay2>(r_pars, pars_multi, time, r_n_particles,
...
SEXP dust_cpu_FullModelODDelay2_set_data(SEXP ptr, cpp11::list data,
                                       bool shared) {
