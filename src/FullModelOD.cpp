...
[[cpp11::register]]
SEXP dust_cpu_FullModelOD_alloc(cpp11::list r_pars, bool pars_multi, size_t step,
...
[[cpp11::register]]
SEXP dust_cpu_FullModelOD_update_state(SEXP ptr, SEXP r_pars, SEXP r_state,
...
[[cpp11::register]]
SEXP dust_cpu_FullModelOD_filter(SEXP ptr, SEXP step_end,
...
public:
  ...
  FullModelOD(const dust::pars_type<FullModelOD>& pars) :
...
namespace dust {
template<>
dust::pars_type<FullModelOD> dust_pars<FullModelOD>(cpp11::list user) {
  using real_type = typename FullModelOD::real_type;
  auto shared = std::make_shared<FullModelOD::shared_type>();
  FullModelOD::internal_type internal;
  shared->FOI_max = 1;
  ...
  return dust::pars_type<FullModelOD>(shared, internal);
}
template <>
cpp11::sexp dust_info<FullModelOD>(const dust::pars_type<FullModelOD>& pars) {
  const FullModelOD::internal_type internal = pars.internal;
  const std::shared_ptr<const FullModelOD::shared_type> shared = pars.shared;
...
using model_cpu = dust::dust_cpu<FullModelOD>;

SEXP dust_cpu_FullModelOD_alloc(cpp11::list r_pars, bool pars_multi, size_t step,
                             cpp11::sexp r_n_particles, size_t n_threads,
                             cpp11::sexp r_seed, bool deterministic,
                             cpp11::sexp gpu_config) {
  return dust::r::dust_cpu_alloc<FullModelOD>(r_pars, pars_multi, step, r_n_particles,
