...
null1 <- create_map(shape_data, epi_data$FOI, scale=pretty(epi_data$FOI, 8), colour_scale, pixels_max=720, text_size=0.75, map_title="", legend_title="FOI", legend_position="topleft", legend_format="e", legend_dp=1, output_file=NULL)
null2 <- create_map(shape_data, epi_data$R0, scale=pretty(epi_data$R0, 8), colour_scale, pixels_max=720, text_size=0.75, map_title="", legend_title="R0", legend_position="topleft", legend_format="f", legend_dp=1, output_file=NULL)
```
