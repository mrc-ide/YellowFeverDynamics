...
[[cpp11::register]]
SEXP dust_cpu_SEIRVModelSplitInfection_alloc(cpp11::list r_pars, bool pars_multi, cpp11::sexp r_time,
...
[[cpp11::register]]
SEXP dust_cpu_SEIRVModelSplitInfection_update_state(SEXP ptr, SEXP r_pars, SEXP r_state,
...
[[cpp11::register]]
SEXP dust_cpu_SEIRVModelSplitInfection_filter(SEXP ptr, SEXP time_end,
...
// [[dust::class(SEIRVModelSplitInfection)]]
...
namespace dust {
template<>
dust::pars_type<SEIRVModelSplitInfection> dust_pars<SEIRVModelSplitInfection>(cpp11::list user) {
  using real_type = typename SEIRVModelSplitInfection::real_type;
  auto shared = std::make_shared<SEIRVModelSplitInfection::shared_type>();
  SEIRVModelSplitInfection::internal_type internal;
  shared->FOI_max = 1;
  ...
  for (int i = 1; i <= shared->N_age; ++i) {
    shared->initial_E_sylv[i - 1] = shared->E_0[i - 1];
  }
  for (int i = 1; i <= shared->N_age; ++i) {
    shared->initial_I_sylv[i - 1] = shared->I_0[i - 1];
  }
  for (int i = 1; i <= shared->N_age; ++i) {
...
using model_cpu = dust::dust_cpu<SEIRVModelSplitInfection>;
...
SEXP dust_cpu_SEIRVModelSplitInfection_alloc(cpp11::list r_pars, bool pars_multi, cpp11::sexp r_time,
                             ...
                             cpp11::sexp r_seed, bool deterministic,
                             cpp11::sexp gpu_config, cpp11::sexp ode_control) {
  return dust::r::dust_cpu_alloc<SEIRVModelSplitInfection>(r_pars, pars_multi, r_time, r_n_particles,
...
SEXP dust_cpu_SEIRVModelSplitInfection_simulate(SEXP ptr, cpp11::sexp r_time_end) {
...
SEXP dust_cpu_SEIRVModelSplitInfection_set_data(SEXP ptr, cpp11::list data,
                                       bool shared) {
