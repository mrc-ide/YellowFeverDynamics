...
FullModelODVarFR <- R6::R6Class(
  ...
  public = list(
    ...
    has_openmp = function() {
      dust_FullModelODVarFR_capabilities()[["openmp"]]
    },
    ...
    has_gpu_support = function(fake_gpu = FALSE) {
      if (fake_gpu) {
        ...
        dust_FullModelODVarFR_capabilities()[["gpu"]]
      }
    },

    has_compare = function() {
      dust_FullModelODVarFR_capabilities()[["compare"]]
    },

    real_size = function() {
      dust_FullModelODVarFR_capabilities()[["real_size"]]
    },

    rng_algorithm = function() {
      dust_FullModelODVarFR_capabilities()[["rng_algorithm"]]
    },
