...
for(n_region in 1:n_regions){
 FOI_R0_values <- param_calc_enviro(enviro_coeffs[1, ], enviro_data[n_region, c(2:ncol(enviro_data))])
...
```{r,eval=FALSE}
enviro_coeffs2 <- read.csv(file = paste(path.package("YellowFeverDynamics"), "/inst/exdata/enviro_coeffs_example2.csv", sep = ""), header = TRUE)
