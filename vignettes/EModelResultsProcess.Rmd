...
A set of epidemiological data for multiple regions can be constructed using the data_match_single() function as described in vignette 6; this combines running the model as described in vignette 4 and calculating epidemiological output data as described in this vignette.
