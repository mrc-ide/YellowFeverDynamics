...
This vignette demonstrates how the output of the dynamic yellow fever model functions (see [Worked Example 1 - Single Model Run](https://mrc-ide.github.io/YellowFeverDynamics/articles/AWorkedExampleAModelRun.html)) can be processed to produce epidemiological data similar to that produced by real-world surveillance. There are three types of data processed by the package:
